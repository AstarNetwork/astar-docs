...
To use the service, developers define a Subgraph, which specifies how blockchain data is indexed. The Graph then processes these subgraphs and makes the data accessible through GraphQL, a popular query language.
...
:::note
In order to use your subgraph on The Graph's decentralized network, you will need to create an API key. It is also recommended that you [add signal](https://thegraph.com/docs/en/network/curating/#how-to-signal) to your subgraph with at least 10,000 GRT.
:::

## Prerequisites

Before you start exploring the contents of the manifest file and building and deploying subgraphs, you will need to install the [Graph CLI](https://github.com/graphprotocol/graph-cli). 
