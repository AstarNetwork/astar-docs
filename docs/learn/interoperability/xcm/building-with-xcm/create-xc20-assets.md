...
2. Enter the address that will receive the minted tokens. We recommend using a [multisig](/docs/use/get-started/astar-substrate-wallet/multisig-wallet/polkadot.js/index.md).
