...
> The implementation of Schnorr signatures used in Polkadot that implements the Schnorrkel protocols over the Ristretto compression of the Curve25519, is known as sr25519.
