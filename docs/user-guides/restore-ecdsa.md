...
2. Go to "Settings".
3. Select "Allow local in-browser account storage".
4. Click "Save".
...
8. Expand "Advanced creation options" and select “ECDSA”.
...
7. Your ECDSA wallet is now restored on Polkadot.js and you can use with Astar Portal.
